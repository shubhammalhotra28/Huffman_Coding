...
class HuffmanCoding:
	...
	def __buildCodesHelper(self,root,curr_bits):
		...
		if root is None:
			return
		if root.value is not None: # leaf Node
	...
	def compress(self):
		...
		with open(self.path,'r+') as file , open(output_path,'wb') as output:
			...
			#Construct the heap from the frquency_dict
			...
			# constreuct the codes from binary tree
			self.__buildCodes()

			# create encoded test
			encoded_text = self.__getEncodedText(text)
		
			# padding the enoded text	
			...
			#putting this encoded text into binary file
...
path = '/Users/shubhammalhotra/Desktop/python/sample.txt'
